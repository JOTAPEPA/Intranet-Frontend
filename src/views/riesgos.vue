        ...
        <div class="admin-container">
            ...
            <div class="main-content">
                ...
                <div class="q-pa-md q-gutter-sm">
                    ...
                    <!-- Diálogo para mover documento -->
                    <q-dialog v-model="showMoveItemsDialog" persistent>
                        <q-card class="move-items-dialog">
                            <q-card-section class="dialog-header">
                                <div class="dialog-title">
                            ...
                            <q-card-actions align="right" class="q-pa-md">
                                <q-btn flat label="Cancelar" color="grey-7" @click="cancelMoveDocument" />
                                <q-btn
                                    unelevated
                                    label="Mover"
                                    color="primary"
                ...
                <div class="table-container">
                    ...
                    <q-table :rows="getCurrentFolderItems()" :columns="folderColumns" row-key="index" flat class="data-table"
...
// ⭐ URL base del API para riesgos
const API_BASE_URL = 'http://localhost:5000/api/riesgos'
...
const selectedUploadFolder = ref(null) // Carpeta seleccionada para subir archivos
...
onMounted(async () => {
    console.log('🚀 Inicializando vista de riesgos...')
...
function resetUpload() {
    ...
    selectedUploadFolder.value = getCurrentPathString() // Resetear a carpeta actual
}
...
/* Item name cell (carpetas y documentos) */
.item-name-cell {
    cursor: pointer;
}
